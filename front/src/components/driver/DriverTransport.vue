<template>
  ...
  <el-table :data="tpList" :default-sort="{prop:'transport.tnum',order:'ascending'}" stripe>
    ...
    <el-table-column prop="driver.name" label="司机姓名" sortable/>
    ...
    <el-table-column prop="status" label="状态" sortable
                     :filters="TransportStatusFilters" :filter-method="filterHandler" filter-placement="bottom-end">
    ...
    <el-table-column fixed="right" label="操作">
      <template #default="scope">
        ...
        <el-button v-if="!adminMod" link type="primary" size="small" @click="driverArrive(scope.row)"
                   :disabled="scope.row.status!=='司机接单'">抵达
        </el-button>
      </template>
    </el-table-column>
  </el-table>
